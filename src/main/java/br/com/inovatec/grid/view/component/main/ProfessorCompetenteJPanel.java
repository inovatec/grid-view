 ...
 * @author zrobe
 */
public class ProfessorCompetenteJPanel extends javax.swing.JPanel implements MouseListener {
    ...
    /**
     * Creates new form ProfessorCompetenteJPanel
     * @param professor
     */
    public ProfessorCompetenteJPanel(Professor professor) {
        initComponents();
    ...
    private void init() {
        // Nome
        this.nomeJLabel.setText(this.professor.getNomeReduzido());
        // Icones
        this.iconJLabel.setIcon(Icons.IC_PROFESSOR_COMPETENTE);
    ...
    public void block() {
        this.released = false;
        this.statusJLabel.setText("Indisponível");
    ...
    public void release() {
        this.released = true;
        this.statusJLabel.setText("Disponível");
