...
public class Styles {
    ...
    public static final Font FONT_FAMILY = new Font("Ubuntu", Font.PLAIN, Dimens.DEFAULT_FONT_SIZE);
    public static final Font FONT_FAMILY_BOLD = new Font("Ubuntu", Font.BOLD, Dimens.DEFAULT_FONT_SIZE);
